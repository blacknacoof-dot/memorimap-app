...
const CONFIG = {
    ...
    localDir: 'C:\\Users\\black\\Desktop\\memorimap\\data\\반려동물장례',
    storagePath: 'optimized-pet',
    // DB types for Pet Funeral
...
async function main() {
    ...
    // 2. Distribute
    console.log('🔍 Fetching target Pet Funeral facilities...');
    ...
    console.log(`🎯 Found ${facilities.length} Pet Funeral facilities to update.`);
    ...
    console.log(`\n🎉 Successfully updated ${updateCount} Pet Funeral facilities!`);
}
