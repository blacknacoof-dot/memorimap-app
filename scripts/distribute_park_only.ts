...
async function main() {
    ...
    // 2. Distribute
    console.log('🔍 Fetching target Park Cemetery facilities...');
    ...
    console.log(`🎯 Found ${facilities.length} Park Cemeteries to update.`);
    ...
    for (const facility of facilities) {
        ...
        if (updateError) {
            ...
            updateCount++;
            if (updateCount % 20 === 0) process.stdout.write('.');
        }
    }

    console.log(`\n🎉 Successfully updated ${updateCount} Park Cemeteries!`);
}
