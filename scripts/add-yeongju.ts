...
async function addYeongju() {
    console.log("🏥 영주적십자병원 장례식장 추가 중...\n");

    const facility = {
        name: '영주적십자병원장례식장',
        address: '경상북도 영주시 대학로 327 (가흥동)',
        phone: '054-630-0128'
    };

    console.log("📍 좌표 검색 중...");
    const naverData = await searchNaver('영주적십자병원');
