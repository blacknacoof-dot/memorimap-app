                    ...
                    {CATEGORIES.map((cat) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-3 py-2 md:px-3 md:py-1.5 rounded-full text-[11px] md:text-[11px] font-medium shadow-sm border whitespace-nowrap transition-colors flex-shrink-0 min-h-[44px] md:min-h-[36px] ${isSelected
