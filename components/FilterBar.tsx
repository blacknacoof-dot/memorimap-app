                    ...
                    {CATEGORIES.map((cat) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-full text-[11px] font-bold border whitespace-nowrap transition-colors flex-shrink-0 min-h-[44px] md:min-h-[34px] shadow-sm touch-manipulation ${isSelected
