  ...
  return (
    <>
      ...
      {viewState !== ViewState.MY_PAGE && !isMenuOpen && (
        <div className="absolute top-[4.2rem] md:top-[4.5rem] left-0 right-0 z-40 px-3 md:px-4 pointer-events-none animate-in fade-in slide-in-from-top-1 duration-300">
      ...
      {showPromo && (viewState === ViewState.MAP || viewState === ViewState.LIST) && (
        <div className="absolute left-3 right-3 md:left-4 md:right-4 z-20 animate-in fade-in slide-in-from-top-2 transition-all duration-300 top-[7.2rem] md:top-[7.5rem]">
