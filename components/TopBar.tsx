  ...
  return (
    <>
      ...
      {showPromo && viewState === ViewState.MAP && (
        <div className="standalone-hide absolute left-3 right-3 md:left-4 md:right-4 z-20 animate-in fade-in slide-in-from-top-2 transition-all duration-300 top-[5.75rem] md:top-[9rem]">
