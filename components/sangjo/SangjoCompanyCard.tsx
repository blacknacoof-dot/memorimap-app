    ...
    return (
        ...
        >
            ...
            <button
                ...
                className={`absolute right-2 top-2 p-3 rounded-full transition-all shadow-sm z-10 min-w-[44px] min-h-[44px] flex items-center justify-center ${isFavorited
            ...
            <button
                ...
                className={`absolute right-2 bottom-2 p-3 rounded-full transition-colors border shadow-sm z-10 min-w-[44px] min-h-[44px] flex items-center justify-center ${isCompared
