    ...
    return (
        <div className="h-full flex flex-col bg-gray-50 pt-24 relative">
                ...
                {filteredCompanies.map(company => (
                    ...
                    >
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-50 flex items-center justify-between">
                            ...
                            {/* 'View Details' removed to prevent overlap with Comparison Button */}
                            <div className="flex items-center text-gray-300 group-hover:text-primary transition-colors opacity-0">
                                {/* Hidden placeholder or just remove entirely. Removing content but keeping structure if needed for justfy-between, strictly removing the text/icon is better. */}
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <div className="absolute bottom-20 left-0 right-0 px-4 z-40 animate-in slide-in-from-bottom-4 duration-500">
                {/* Floating Compare Button - Positioned consistently */}
            ...
            {showConsultation && (
                <SangjoConsultationModal
                    ...
                    onCompanySelect={(company) => {
                        // Close local modal and switch to global context with chat open
