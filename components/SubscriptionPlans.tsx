...
const facilityPlans: Plan[] = [
    {
        ...
        features: [
            ...
            { name: '마이페이지 예약 내역 확인', included: true },
            { name: '리뷰 조회', included: true },
            { name: 'AI 채팅 상담', included: false },
            { name: '고객 인앱 알림', included: false },
        ],
    },
    {
        id: 'BASIC',
        ...
        features: [
            ...
            { name: '고객 마이페이지 상태 업데이트', included: true },
    ...
    },
    {
        ...
        features: [
            ...
            { name: '고객 인앱 알림 연동', included: true },
...
const enterprisePlan: Plan = {
    ...
    features: [
        ...
        { name: 'AI 상담 및 인앱 알림 연동', included: true },
