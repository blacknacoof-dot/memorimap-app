                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex flex-col items-start gap-1">
                                                <button onClick={() => onSwitchToFacility?.({ id: f.id, name: f.name, address: f.address, phone: f.phone })} className="w-full text-[15px] font-bold text-orange-700 hover:underline text-left leading-tight break-all line-clamp-2">{f.name}</button>
