                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex justify-between items-start">
                                                    <button onClick={() => onSwitchToFacility?.({ id: f.id, name: f.name, address: f.address, phone: f.phone })} className="min-w-0 pr-2 font-bold text-sm text-indigo-700 hover:underline text-left leading-snug whitespace-normal break-words">{f.name}</button>
