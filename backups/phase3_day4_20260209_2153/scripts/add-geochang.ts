...
async function addGeochang() {
    console.log("🏥 거창적십자병원 장례식장 추가 중...\n");

    const facility = {
        name: '거창적십자병원장례식장',
        address: '경상남도 거창군 거창읍 중앙로 91 (상림리)',
        phone: '055-944-4482'
    };

    console.log("📍 좌표 검색 중...");
    const naverData = await searchNaver('거창적십자병원');
    ...
    const { data, error } = await supabase
        ...
        .insert([{
            ...
            data_source: 'manual',
            is_verified: true,
            image_url: 'https://images.unsplash.com/photo-1465146633011-14f8e0781093?w=800',
            description: '',
